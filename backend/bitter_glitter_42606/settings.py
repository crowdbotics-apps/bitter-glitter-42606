"""
Django settings for bitter_glitter_42606 project.
...
ROOT_URLCONF = 'bitter_glitter_42606.urls'
...
WSGI_APPLICATION = 'bitter_glitter_42606.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bitter_glitter_42606 API",
    "DESCRIPTION": "API documentation for bitter_glitter_42606 App",
    "VERSION": "v1",
}
